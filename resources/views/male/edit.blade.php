...
@section('index')
    ...
    <form method="post" enctype="multipart/form-data" action="{{route('model.update',$male->id)}}">
        @csrf
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        @endif
                            "
                               id="name" name="name" value="{{$male->name}}">
                        @if($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        @endif
                            "
                               id="dateOfBirth" name="dateOfBirth" value="{{$male->dateOfBirth}}">
                        @if($errors->has('dateOfBirth'))
                            <p class="text-danger"><i class='fas fa-exclamation-circle'
                    ...
                    <div class="form-group">
                        ...
                        @endif
                            "
                               id="height" name="height" value="{{$male->height}}">
                        @if($errors->has('height'))
                            <p class="text-danger"><i class='fas fa-exclamation-circle'
                    ...
                    <div class="form-group">
                        ...
                        @endif
                            "
                               id="national" name="national" value="{{$male->national}}">
                        @if($errors->has('national'))
                            <p class="text-danger"><i class='fas fa-exclamation-circle'
                    ...
                    <div class="form-group">
                        ...
                        @endif
                            "
                               id="description" name="description" rows="5" >{{$male->description}}
                        </textarea>
                        @if($errors->has('description'))
                            <p class="text-danger"><i class='fas fa-exclamation-circle'
                    ...
                    <div class="form-group">
                        ...
                        @endif
                            "
                               id="job" name="job" value="{{$male->job}}">
                        @if($errors->has('job'))
                            <p class="text-danger"><i class='fas fa-exclamation-circle'
                    ...
                    <div class="form-group">
                        <img src="{{asset('storage/image/'.$male->image)}}"  style="width: 100px;height: 150px">
